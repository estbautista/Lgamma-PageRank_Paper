...
% Tue Feb 19 11:02:48 CDT 2019
%
% Experiment of Sec. 4.3
% Script to assess the performance on the on the Gender dataset with 
...
N = 200;
data = [data_female(1:N,:); data_male(1:N,:)];
...
clear data_female;
clear data_male;
save('Gender_unbalanced_results');
