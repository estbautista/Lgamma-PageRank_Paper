...
% Tue Feb 19 11:02:15 CDT 2019
%
% Experiment of Sec. 4.3
% Script to assess the performance on the on the MNIST (4 vs 9) with 
...
idx_trainCA = find(train_labels == 4);
idx_trainCB = find(train_labels == 9);
...
clear test_data;
clear test_labels;
save('MNIST4v9_unbalanced_results');
