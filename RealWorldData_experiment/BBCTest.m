...
% Fri Feb  8 10:13:50 CDT 2019
%
% Experiment of Sec. 4.2 
% Script to assess the performance on the BBC dataset
%
% RESULTS
...
data = [BBCdata(idx_c1(1:200),:); BBCdata(idx_c2(1:200),:)];
N1 = 200;
N2 = 200;
...
ind1 = indic_fun(N,1:200);
ind2 = indic_fun(N,201:400);
...
%% Run test
numIt = 100;    % realization of labeled points
